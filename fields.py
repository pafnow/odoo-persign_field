...
class Percent(Float):
    """ Basic percent field, can be length-limited, usually displayed as a percent"""
    type = 'percent'
...
class Permille(Percent):
    """ Basic permille field, can be length-limited, usually displayed as a permille"""
    type = 'permille'


fields.Percent = Percent
fields.Permille = Permille
